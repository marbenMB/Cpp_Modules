...
/*   Updated: 2022/11/22 15:02:00 by mbenbajj         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::attack (std::string const &target)
{
	if (this->_energy && this->_hitPt)
	{
		std::cout << "ClapTrap " << this->_name << " attacks " << target << \
				" , casing " << this->_damage << " points of damage!" << std::endl;
		if (this->_damage < 10)
			this->_damage++;
		this->_energy--;
	}
...
void	ClapTrap::takeDamage (unsigned int amount)
{
	if (this->_energy && this->_hitPt)
	{
		std::cout << "ClapTrap " << this->_name << " lose " << amount - 1 << " hit points!" << std::endl;
		if (this->_damage < 0)
			this->_damage--;
		this->_hitPt -= amount;
		if (this->_hitPt < 0)
		...
		std::cout << "ClapTrap " << this->_name << " Is suffers!" << std::endl;
}
...
void	ClapTrap::beRepaired (unsigned int amount)
{
	if (this->_energy && this->_hitPt)
	{
		std::cout << "ClapTrap " << this->_name << " gain " << amount << " hit point!" << std::endl;
		this->_hitPt += amount;
		this->_energy--;
	}
}
